...
class SU_Linkbox extends SU_Module {
	...
	function admin_page_contents() {
		...
		$this->checkboxes(array('filter_posts'	=> __('Al final de una entrada', 'seo-ultimate')
							,	'filter_pages'	=> __('Al final de una página', 'seo-ultimate')
		), __('Dónde quieres meterlo?', 'seo-ultimate'));
		$this->textarea('html', __('Caja de código (acepta HTML)', 'seo-ultimate'));
