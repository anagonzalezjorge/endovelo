...
class SU_LinkNofollow extends SU_Module {
	...
	static function get_module_title() { return __('TPNotesigo', 'seo-ultimate'); }
	...
	function admin_page_contents() {
		...
		$this->checkboxes(array(
				  'nofollow_adjacent_post' => __('La paginacion (el típico <strong>next post/previous post</strong>)', 'seo-ultimate')
				, 'nofollow_category_loop' => __('Enlaces a categorías (después de las entradas)', 'seo-ultimate')
				, 'nofollow_category_list' => __('Enlaces de categorías (dentro de las listas)', 'seo-ultimate')
				, 'nofollow_comment_popup' => __('Enlaces con texto de ancla (en los comentarios)', 'seo-ultimate')
				, 'nofollow_comment_feed' => __('Enlaces en el <em>feed</em> (de los comentarios)', 'seo-ultimate')
				, 'nofollow_date_archive' => __('Date-based archive links', 'seo-ultimate')
				, 'nofollow_paged' => __('TODOS los enlaces de paginacion', 'seo-ultimate')
				, 'nofollow_paged_home' => __('La paginacion (solo de la home)', 'seo-ultimate')
				, 'nofollow_post_more' => __('Enlaces de &#8220;Leer más&#8221;', 'seo-ultimate')
				, 'nofollow_register' => __('Enlace de registro', 'seo-ultimate')
				, 'nofollow_login' => __('Enlace de login', 'seo-ultimate')
				, 'nofollow_tag_loop' => __('Todas las <em>tags</em> (después de las entradas)', 'seo-ultimate')
				, 'nofollow_tag_list' => __('Todas las <em>tags</em> (listas y nubes)', 'seo-ultimate')
			), __('Añadir el atributo <strong>NOFOLLOW</strong> en...', 'seo-ultimate'));
