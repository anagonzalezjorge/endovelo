...
class SU_Canonical extends SU_Module {
	...
	static function get_module_title() { return __('LoCanonicalizoTODO', 'seo-ultimate'); }
	...
	function admin_page_contents() {
		...
		$this->checkboxes(array(
				  'link_rel_canonical' => __('Generar <code>&lt;link rel=&quot;canonical&quot; /&gt;</code> en las <em>meta tags</em>', 'seo-ultimate')
				, 'http_link_rel_canonical' => __('Mandar <code>rel=&quot;canonical&quot;</code> al <em>HTTP headers</em>', 'seo-ultimate')
			), __('Generar canonical', 'seo-ultimate'));
		$this->radiobuttons('canonical_url_scheme', array(
			  '' => __('Usar <code>http://</code> o <code>https://</code> dependiendo de como acceda el usuario al sitio web', 'seo-ultimate')
			, 'http' => __('Usar siempre el <code>http://</code>', 'seo-ultimate')
			, 'https' => __('Usar siempre el <code>https://</code>', 'seo-ultimate')
		), __('Tipo de canonical', 'seo-ultimate'));
		$this->checkboxes(array(
				  'remove_nonexistent_pagination' => __('Redirigir las solicitudes de paginacion inexistentes', 'seo-ultimate')
			), __('Hacer una redirección 301 automática', 'seo-ultimate'));
