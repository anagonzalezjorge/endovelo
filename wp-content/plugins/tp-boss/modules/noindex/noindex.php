...
class SU_Noindex extends SU_Module {
	...
	function get_admin_page_tabs() {
		...
		return array_merge(
			  array(
				  array('title' => __('Prevenir indexación de...', 'seo-ultimate'), 'id' => 'su-default-values', 'callback' => 'defaults_tab')
				)
	...
	function defaults_tab() {
		...
		$this->admin_form_subheader(__('Marca todo lo que no pretendes indexar...', 'seo-ultimate'));
		$this->checkboxes(array('noindex_admin' => __('Back-End (páginas de administración)', 'seo-ultimate')
							,	'noindex_author' => __('Archivos de autor', 'seo-ultimate')
							,	'noindex_search' => __('Páginas del buscador interno', 'seo-ultimate')
							,	'noindex_category' => __('Categorias', 'seo-ultimate')
							,	'noindex_comments_feed' => __('Comentarios (feed)', 'seo-ultimate')
							,	'noindex_cpage' => __('Comentarios (subpáginas)', 'seo-ultimate')
							,	'noindex_date' => __('Archivos basados en fechas', 'seo-ultimate')
							,	'noindex_home_paged' => __('Subpáginas de la home', 'seo-ultimate')
							,	'noindex_tag' => __('Etiquetas', 'seo-ultimate')
							,	'noindex_login' => __('Login/Registro (páginas)', 'seo-ultimate')
		));
