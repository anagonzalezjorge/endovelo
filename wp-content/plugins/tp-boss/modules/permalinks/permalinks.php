...
class SU_Permalinks extends SU_Module {
	...
	static function get_module_title() { return __('TPEscoba', 'seo-ultimate'); }
	...
	function admin_page_contents() {
		...
		$this->admin_form_group_start(__('Limpiar la URL y dejarla sin...', 'seo-ultimate'));
		
		echo "<tr><td>\n";
		$this->admin_wftable_start(array(
			  'taxonomy' => ' '
			, 'before' => __('Antes', 'seo-ultimate')
			, 'arrow' => ' '
			, 'after' => __('Después', 'seo-ultimate')
		));
		...
		), __('Conflictos de URL', 'seo-ultimate'), __('Si una entrada y una página con el mismo <em>slug</em> tienen la misma URL debido a los cambios realizados, se deberá tener en cuenta... %s.', 'seo-ultimate'));
