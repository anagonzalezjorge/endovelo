...
class SU_SharingButtons extends SU_Module {
	...
	static function get_module_title() { return __('TPShare', 'seo-ultimate'); }
	...
	*/
	...
	function admin_page_contents() {
		...
		$this->radiobuttons('provider', array(
			  'none' => __('NADA; ¿para qué quiero yo compartir mi contenido?', 'seo-ultimate')
			, 'sharethis' => __('Usa los botones por defecto de <strong>ShareThis</strong>', 'seo-ultimate') //: %s{sharethis_code}
			, 'addthis' => __('Usa los botones por defecto de <strong>AddThis</strong>', 'seo-ultimate') //: %s{addthis_code}
		), __('Quieres botones para compartir sin usar un otro plugin?', 'seo-ultimate'));
