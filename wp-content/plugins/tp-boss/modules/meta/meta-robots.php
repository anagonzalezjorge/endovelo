...
class SU_MetaRobots extends SU_Module {
	...
	static function get_module_title() { return __('MetaTags - Editor de arañas', 'seo-ultimate'); }
	static function get_menu_title()   { return __('TPRobots', 'seo-ultimate'); }
	...
	function get_admin_page_tabs() {
		return array(
			array('title' => __('Arañas', 'seo-ultimate'), 'id' => 'su-sitewide-values', 'callback' => 'global_tab')
		);
	}
	...
	function global_tab() {
		...
		$this->checkboxes(array(
				  'noodp' => __('Evita que Google añada por defecto la descripción del "Open Directory" (el famoso <strong>NOODP</strong>).', 'seo-ultimate')
				, 'noydir' => __('Evita que Google añada por defecto la descripción del directorio de Yahoo en las SERPs (conocido cómo <strong>NOYDIR</strong>).', 'seo-ultimate')
				, 'noarchive' => __('Evita que Google cachee el sitio web (nuestro querido <strong>NOARCHIVE</strong>).', 'seo-ultimate')
			), __('Instrucciones para las arañas...', 'seo-ultimate'));
