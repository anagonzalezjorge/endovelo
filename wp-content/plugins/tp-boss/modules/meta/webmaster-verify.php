...
class SU_WebmasterVerify extends SU_Module {
	...
	static function get_module_title() { return __('Asistente de verificación', 'seo-ultimate'); }
	static function get_menu_title() { return __('TPVerification', 'seo-ultimate'); }
	...
	function get_supported_search_engines() {
		return array(
			  'google' => array(
				  'title' => __('GMT o WMT', 'seo-ultimate')
				, 'meta_name' => 'google-site-verification'
			), 'microsoft' => array(
				  'title' => __('Bing Webmasters', 'seo-ultimate')
	...
	function admin_page_contents() {
		...
		$this->admin_wftable_start(array(
			  'portal' => __('Sitio', 'seo-ultimate')
			, 'meta_tag_before' => __('Tu código', 'seo-ultimate')
			, 'meta_tag' => ' '
			, 'meta_tag_after' => ' '
		));
