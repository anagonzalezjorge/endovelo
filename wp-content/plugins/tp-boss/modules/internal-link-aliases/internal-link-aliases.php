...
class SU_InternalLinkAliases extends SU_Module {
	...
	static function get_module_title() { return __('Enmascara tus enlaces', 'seo-ultimate'); }
	static function get_menu_title() { return __('TPMask', 'seo-ultimate'); }
	...
	function get_admin_page_tabs() {
		return array(
			  array('id' => 'aliases',  'title' => __('TPMask Links', 'seo-ultimate'),  'callback' => 'editor_tab')
			, array('id' => 'settings', 'title' => __('Escoge la máscara', 'seo-ultimate'), 'callback' => 'settings_tab')
		);
	}
	...
	function editor_tab() {
		...
		$this->admin_subheader(__('Crea un nuevo MaskLink', 'seo-ultimate'));
	...
	function aliases_form($start_id = 0, $aliases, $existing_item = true) {
		...
		//Set headers
		$headers = array(
			  'alias-from' => __('URL original', 'seo-ultimate')
			, 'alias-to' => __('Máscara <em>(puedes editarla en "Escoge la máscara")</em>', 'seo-ultimate')
			, 'alias-posts' => __('SOLO en la entrada&hellip; <em>(añade la URL aquí)</em>', 'seo-ultimate')
		);
...
<table><tr>
	...
	function settings_tab() {
		...
		if ($this->plugin->module_exists('link-nofollow'))
			$this->checkbox('nofollow_aliased_links', __('Enlace NOFOLLOW', 'seo-ultimate'), __('Atributos del enlace', 'seo-ultimate'));
