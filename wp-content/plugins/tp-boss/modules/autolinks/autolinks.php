...
class SU_Autolinks extends SU_Module {
	static function get_module_title() { return __('Enlazamiento interno automatizado', 'seo-ultimate'); }
	static function get_menu_title() { return __('TPLinking', 'seo-ultimate'); }
