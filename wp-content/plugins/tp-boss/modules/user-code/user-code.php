...
class SU_UserCode extends SU_Module {
	...
	static function get_module_title() { return __('Incrustador de código', 'seo-ultimate'); }
	static function get_menu_title() { return __('TPIncruster', 'seo-ultimate'); }
	...
	function admin_page_contents() {
		...
		$textareas = array(
			  'wp_head' => __('&lt;HEAD&gt;', 'seo-ultimate')
			, 'the_content_before' => __('Antes del contenido', 'seo-ultimate')
			, 'the_content_after' => __('Después del contenido', 'seo-ultimate')
			, 'wp_footer' => __('En el "Footer"', 'seo-ultimate')
		);
