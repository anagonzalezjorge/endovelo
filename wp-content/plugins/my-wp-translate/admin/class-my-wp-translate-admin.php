...
class MY_WP_Translate_Admin {
	 ...
	 *
	 * @link   http://php.net/manual/en/function.unserialize.php#85097
	 * @since  1.0.0
	 *
	 * @param string $str String for serialize.
	 */
	public function is_serialized( $str ) {
		return ( serialize( false ) === $str || @unserialize( $str ) !== false );
	}
	...
	public function ajax_import_strings() {
		...
		if ( $this->is_serialized( $import_code ) ) {
