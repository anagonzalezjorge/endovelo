...
if (!empty($_POST['submit-css']) && $_POST['submit-css'] == 'Save' && is_numeric($_POST['itemcssid'])) {
    ...
    if (!wp_verify_nonce($nonce, 'ihewcsavestyle')) {
        ...
        $css = ' image-effects |' . sanitize_text_field($_POST['image-effects']) . '|'
                . ' image-background-color |rgba(0, 166, 191, 1)|'
                . ' image-alignments |' . sanitize_text_field($_POST['image-alignments']) . '|'
                . ' title-color |' . sanitize_text_field($_POST['title-color']) . '|'
                . ' title-animation ||'
                . ' desc-color |' . sanitize_text_field($_POST['desc-color']) . '|'
                . ' desc-animation ||'
                . ' buttom-color |' . sanitize_text_field($_POST['buttom-color']) . '|'
                . ' buttom-animation ||'
                . ' buttom-background |' . sanitize_text_field($_POST['buttom-background']) . '|'
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'ihewcstylecss')) {
        ...
        $data = 'ihewc-image-type |' . sanitize_text_field($_POST['ihewc-image-type']) . '|'
                ...
                . ' carousel-auto-timing |1100|'
                . ' ihewc-animations ||'
                . ' animation-timing |1.0| |';
                            ...
                            <div class="ctu-ultimate-style-3-content">
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    <div class="ihewc-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row " id="carousel-autoplay-hidden-show">
                                            <label class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Slide AutoPlay Yes or No">Autoplay <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-info <?php
                                    ...
                                    <div class="ihewc-admin-style-settings-div-right">
                                        <div class="form-group row form-group-sm">
                                            <label for="ihewc-animations" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Select Animation when Our Image Will View">View Animation  <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="animation-timing" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title=" Animation Duration " >Animation Duration <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Image or Button Text Url Open System. Same Browser or New Tabs">Open New Tab? <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-info <?php
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="box-shadow" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Add box Shadow on Your Image or Hover Items, No need means make 0" >Box Shadow <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                                <input type="number" class="form-control" id="box-shadow" name="box-shadow" value="<?php echo $styledata[13]; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row form-group-sm">
                                            <label for="box-shadow-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Box Shadow Color">Box Shadow Color <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="ihewc-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="heading-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Title Preferred font, Based on Google Font"> Font Family <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="heading Underline want or Not">Heading Underline <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-info <?php
                                                    if ($styledata[23] == 'yes') {
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Descriptions Preferred font, Based on Google Font"> Description Font Family <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                    ...
                                    <div class="ihewc-admin-style-settings-div-right">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Button Preferred font, Based on Google Font"> Button Font Family <span class="ctu-pro-only-big">Pro</span></label>
                                            <div class="col-sm-6 nopadding">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-2">
                                    <div class="ihewc-admin-style-settings-div-css">
                                        <div class="form-group">
                                            <label for="ihewc-css">Add Your Custom CSS Code Here  <span class="ctu-pro-only-big">Pro</span></label>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-1">
                                    <div class="ihewc-admin-style-settings-div-css">
                                        <div class="col-xs-12">
                                            <iframe width="100%" height="500" src="https://www.youtube.com/embed/KUUgYzE3nqI" frameborder="0" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
