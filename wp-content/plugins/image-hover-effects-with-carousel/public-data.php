    ...
    foreach ($listdata as $value) {       
        ...
        if ($stylename == 'fade-effects') {
            echo ' .ihewc-hover-' . $styleid . '-' . $value['id'] . ' .ihewc-hover-figure-caption{
                        background-color: rgba(0, 204, 180, 1);
            }';
        }
        ...
        if ($stylename == 'blur-effects' ||
                $stylename == 'gradient-effects' ||
                $stylename == 'hinge-effects' ||
                $stylename == 'lightspeed-effects' ||
                $stylename == 'modal-effects' ||
                $stylename == 'parallax-effects' ||
                $stylename == 'pivot-effects' ||
                $stylename == 'pixel-effects' ||
                $stylename == 'push-effects' ||
                $stylename == 'reveal-effects' ||
                $stylename == 'rotate-effects' ||
                $stylename == 'shift-effects' ||
                $stylename == 'shutter-effects' ||
                $stylename == 'slide-effects' ||
                $stylename == 'splash-effects' ||
                $stylename == 'stack-effects' ||
                $stylename == 'strip-effects' ||
                $stylename == 'switch-effects' ||
                $stylename == 'throw-effects' ||
                $stylename == 'zoom-effects') {
            echo '.ihewc-hover-' . $styleid . '-' . $value['id'] . ' .ihewc-hover-figure-caption{
                       background-color: rgba(0, 204, 180, 1);
            }';
        }
